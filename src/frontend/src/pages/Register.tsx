                  ...
                  <CardContent className="pt-4">
                    ...
                    >
                      ...
                      <div className="space-y-2">
                        ...
                        <Textarea
                          id="profile"
                          placeholder="E.g. I'm a commerce graduate currently working as a data entry operator. I have basic computer knowledge and have always been curious about how cyber threats work..."
                          rows={5}
                          value={form.profile}
                          onChange={(e) =>
                      ...
                      <div className="space-y-2">
                        ...
                        <Textarea
                          id="reason"
                          placeholder="E.g. I want to switch careers into cybersecurity because I believe it's the future and I'm passionate about protecting digital assets. I'm particularly interested in SOC analyst roles..."
                          rows={5}
                          value={form.reason}
                          onChange={(e) =>
